...
def openFile():
    ...
    diff = inv_info[index] - qtyObjs
    label_invR_curr = tkinter.Label(frame_ubi_main, text = qtyObjs, borderwidth = 1, relief = "solid", width = 13)
    label_invR_curr.grid(row = 1, column = 4)
    label_dif_curr = tkinter.Label(frame_ubi_main, text = diff, borderwidth = 1, relief = "solid", width = 13)
...
def enterMain():
    ...
    date_text = tkinter.Label(screen, text = "Fecha: " + str(date_info[index]))
